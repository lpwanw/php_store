...
class SanPham
{
    ...
    #[ORM\Column(name: 'gia_goc', type: 'decimal', precision: 12, scale: 0, nullable: true)]
    private ?int $giaGoc = null;
    ...
    public function getGiaGoc(): ?int
    {
        return $this->giaGoc;
    }

    public function setGiaGoc(?int $giaGoc): self
    {
        $this->giaGoc = $giaGoc;
        return $this;
    }
